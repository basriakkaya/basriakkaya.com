...
export const siteConfig = {
  ...
  defaultTitle: 'Basri Akkaya — Güvenlik Araştırmacısı',
  description: "Basri Akkaya'nın siber güvenlik, web uygulama güvenliği, sorumlu açıklama ve yazılım geliştirme üzerine kişisel blogu.",
