...
export const siteConfig = {
  ...
  achievements: [
    { title: 'NASA VDP — 2026 Hall of Fame', titleEn: 'NASA VDP — 2026 Hall of Fame', description: 'NASA Vulnerability Disclosure Program kapsamında kabul edilen iki P1 (kritik öncelik) güvenlik bildirimi: path traversal ve SQL injection. Bugcrowd Hall of Fame kaydı yayımlandı; Letter of Recognition (LOR) bekleniyor.', descriptionEn: 'Two P1 (critical-priority) security submissions accepted under the NASA Vulnerability Disclosure Program: path traversal and SQL injection. The Bugcrowd Hall of Fame entry is public; the Letter of Recognition (LOR) is pending.', url: 'https://bugcrowd.com/h/realkage', status: 'HOF · LOR bekleniyor', statusEn: 'HOF · LOR pending', findings: ['Path Traversal', 'SQL Injection'], evidence: '/images/recognition/nasa-bugcrowd-evidence.png', evidenceAlt: 'Bugcrowd üzerinde NASA hedefi için 13 Ağustos 2026 tarihinde kabul edilmiş iki P1 bildirimi gösteren ekran görüntüsü', evidenceAltEn: 'Screenshot showing two P1 submissions accepted for the NASA target on Bugcrowd on 13 August 2026' },
