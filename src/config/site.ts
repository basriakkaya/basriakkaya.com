...
export const siteConfig = {
  ...
  achievements: [
    ...
    { title: 'U.S. Department of Homeland Security VDP — 2026 Hall of Fame', titleEn: 'U.S. Department of Homeland Security VDP — 2026 Hall of Fame', description: 'Department of Homeland Security Vulnerability Disclosure Program kapsamında *.FEMA.GOV hedefinde bildirilen P3 öncelikli “Sensitive Data Exposure — Disclosure of Secrets” bulgusunun 24 Ağustos 2026 tarihinde kabul edilmesiyle yayımlanan Bugcrowd Hall of Fame kaydı.', descriptionEn: 'Bugcrowd Hall of Fame recognition following the acceptance on 24 August 2026 of a P3 “Sensitive Data Exposure — Disclosure of Secrets” finding reported against the *.FEMA.GOV target under the Department of Homeland Security Vulnerability Disclosure Program.', url: 'https://bugcrowd.com/h/realkage', officialUrl: 'https://www.dhs.gov/publication/vulnerability-disclosure-program-policy-and-rules-engagement', status: 'HOF · P3', statusEn: 'HOF · P3', findings: ['Sensitive Data Exposure', 'Disclosure of Secrets'], findingTitle: 'Hassas Veri İfşası — Gizli Bilgilerin Açığa Çıkması', findingTitleEn: 'Sensitive Data Exposure — Disclosure of Secrets', evidence: '/images/recognition/dhs-fema-bugcrowd-evidence.png', evidenceAlt: 'Bugcrowd üzerinde *.FEMA.GOV hedefi için realkage tarafından bildirilen ve 24 Ağustos 2026 tarihinde P3 önceliğiyle kabul edilen güvenlik bildirimini gösteren ekran görüntüsü', evidenceAltEn: 'Screenshot showing a P3 security submission by realkage accepted for the *.FEMA.GOV target on Bugcrowd on 24 August 2026', evidenceWidth: 1084, evidenceHeight: 232 },
