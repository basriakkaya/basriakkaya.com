...
export const siteConfig = {
  ...
  achievements: [
    ...
    { title: 'University of Twente — 2026 Hall of Fame', titleEn: 'University of Twente — 2026 Hall of Fame', description: 'Sorumlu açıklama kapsamında kabul edilen 1 güvenlik raporu sonucunda “Basri Akkaya (realkage)” adıyla resmî Responsible Disclosure Hall of Fame kaydı.', descriptionEn: 'Official Responsible Disclosure Hall of Fame recognition as “Basri Akkaya (realkage)” for one accepted security report in 2026.', url: 'https://www.utwente.nl/en/cyber-safety/responsible/hall-of-fame/', evidence: '/images/recognition/twente-hof-evidence.png', evidenceAlt: 'University of Twente 2026 Responsible Disclosure Hall of Fame tablosunda Basri Akkaya (realkage) ve kabul edilen 1 raporu gösteren ekran görüntüsü', evidenceAltEn: 'Screenshot showing Basri Akkaya (realkage) and one accepted report in the University of Twente 2026 Responsible Disclosure Hall of Fame table', evidenceWidth: 1712, evidenceHeight: 919 },
