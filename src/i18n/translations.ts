...
const tr = {
  ...
  footerCopy: 'Güvenlik araştırmaları, Linux ve uygulama güvenliği üzerine notlar.', builtWith: 'Astro ile geliştirildi', menu: 'Menüyü aç veya kapat', newTab: ' (yeni sekmede açılır)', email: 'E-posta',
...
const en: Dictionary = {
  ...
  footerCopy: 'Notes on security research, Linux, and application security.', builtWith: 'Built with Astro', menu: 'Open or close menu', newTab: ' (opens in a new tab)', email: 'Email',
