...
for (const route of ['index.html', path.join('en', 'index.html'), path.join('ben-kimim', 'index.html'), path.join('en', 'about', 'index.html')]) {
  ...
  for (const value of ['ASUS PSIRT — 2026 Hall of Fame', 'Basri Akkaya (realkage)', 'asus.com/security-advisory/#hof', route.startsWith('en') ? 'Public Firmware Access' : 'Açık Firmware Erişimi']) if (!html.includes(value)) failures.push(`${route} ASUS HOF içeriği eksik: ${value}`);
